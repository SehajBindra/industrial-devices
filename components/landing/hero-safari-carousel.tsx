    ...
    <Safari url="www.industrialdevices.in">
      <div className="relative size-full bg-neutral-950">
        ...
        <motion.p
          ...
          className="pointer-events-none absolute inset-x-0 bottom-12 z-20 px-6 text-center text-4xl font-medium tracking-tighter text-balance text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)] md:bottom-14 md:text-5xl lg:text-6xl"
        >
          {activeSlide.caption}
        </motion.p>
