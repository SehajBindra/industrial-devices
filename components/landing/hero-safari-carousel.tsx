...
export const heroCarouselSlides = [
  {
    src: "/applications/drinking-water-experience.webp",
    alt: "Children drinking clean water from a public fountain",
  ...
  {
    src: "/applications/process-water-experience.webp",
    alt: "Engineers inspecting a close-up industrial water treatment line",
    caption: "Reliable Water Treatment Begins with Precise Disinfection",
  },
  {
    src: "/applications/wastewater-treatment-experience.webp",
    alt: "Operator checking treated water flow at a wastewater treatment facility",
...
export function HeroSafariCarousel() {
  ...
  return (
    <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-neutral-950 shadow-2xl ring-1 ring-neutral-200">
      {reduceMotion ? (
      ...
      <motion.p
        ...
        className="pointer-events-none absolute inset-x-0 bottom-12 z-20 px-6 text-center text-3xl font-medium text-balance text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)] sm:text-4xl md:bottom-14 md:text-5xl"
      >
        {activeSlide.caption}
      </motion.p>
